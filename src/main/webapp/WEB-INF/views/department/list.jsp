                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <c:forEach items="${list}" var="entity" varStatus="vs">
                            <tr>
                                ...
                                <td>${entity.sn}</td>
                                <td>
                                    <a class="btn btn-info btn-xs btn-input" href="/department/input.do?id=${entity.id}">
                                        <span class="glyphicon glyphicon-pencil"></span> 编辑
                                    </a>
                                    <a href="/department/delete.do?id=${entity.id}" class="btn btn-danger btn-xs btn-delete">
